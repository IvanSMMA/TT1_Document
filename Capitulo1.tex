...
Por último, este Trabajo Terminal estará delimitado por un conjunto de 43 frases divididas en 3 grupos de: saludos (13 frases), situaciones de emergencias (13 frases) y expresiones de mínima comunicación (17 frases). Además, también se contemplan las 27 letras del alfabeto para el deletreo dactilológico, siendo así que el conjunto de datos estará delimitado a 70 elementos.
