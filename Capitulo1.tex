...
Se hará uso de una interfaz de usuario simple e intuitiva, basándose en las Heurísticas de Usabilidad de Nielsen y la norma ISO 9241-210, que sea de utilidad para la población objetivo. Mediante técnicas de Procesamiento de Lenguaje Natural (PLN) se procesará el dataset que contiene las frases en español para generar un conjunto de animaciones fluidas, orientadas a lograr una comunicación visual natural, clara y comprensible.
