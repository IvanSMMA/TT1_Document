...
\begin{itemize}
    ...
    \item Implementar el módulo de animación 3D utilizando Inteligencia Artificial, buscando obtener una representación fluida del lenguaje de señas en los avatares.
...
\begin{center}
    ...
    \captionof{figure}[Diagrama de contexto de la App]{Diagrama del funcionamiento de la App, elaboración propia.}
\end{center}
