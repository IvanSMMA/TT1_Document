...
Por último, este Trabajo Terminal estará delimitado por un conjunto de 33 frases divididas en 3 grupos de 11 frases cada una: saludos, situaciones de emergencias y expresiones de mínima comunicación. Además, también se contemplan las 27 letras del alfabeto para el deletreo dactilológico, siendo así que el conjunto de datos estará delimitado a 60 elementos.
