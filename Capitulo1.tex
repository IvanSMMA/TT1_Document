...
\textbf{Nota aclaratoria}: inicialmente se había planteado realizar el proyecto empleando modelado 3D con herramientas como MediaPipe, Unity y Blender. Sin embargo, debido a ciertas limitaciones de tiempo y recursos, se optó por emplear otro tipo de tecnologías y herramientas para el desarrollo de este Trabajo Terminal con el fin de centrarse en el desarrollo del modulo de Procesamiento de Lenguaje Natural (PLN) y la fluidez de las señas. A pesar de los cambios realizados, toda la teoría relacionada al modulo de animaciones 3D, MediaPipe, Unity y Blender se mantendrá en el \textbf{\nameref{anexo:blender_unity}} para su consulta.\\
...
Estas deficiencias dificultan la comprensión de los mensajes por parte de los usuarios, ya que la secuencia de señas no se presenta con la fluidez y precisión necesarias para lograr una comunicación efectiva. Además, algunos de estos proyectos están orientados a Lenguas de Señas de otros países y fueron desarrollados para versiones antiguas de Android, por lo que no son compatibles con las versiones más recientes del sistema operativo (ver \textbf{\autoref{sec:edoArte}}).\\

\section{Objetivos}
\subsection{Objetivo General}
Desarrollar un prototipo de aplicación móvil en Android que, utilizando técnicas de Procesamiento de Lenguaje Natural (PLN) y Modelado 3D (ver \textbf{\nameref{anexo:blender_unity}}), traduzca oraciones específicas empleadas en situaciones de emergencia, así como expresiones cotidianas como saludos y agradecimientos, del español a la Lengua de Señas Mexicana (LSM).
...
\begin{itemize}
    ...
    \item Construir un módulo de animación 3D que represente visualmente las señas en LSM, a partir de las oraciones procesadas (ver \textbf{\nameref{anexo:blender_unity}}).
    \item Implementar el módulo de animación 3D utilizando Inteligencia Artificial (IA), buscando obtener una representación fluida de la Lengua de Señas en los avatares (ver \textbf{\nameref{anexo:blender_unity}}).
...
\textbf{Nota aclaratoria}: durante el desarrollo de este proyecto se decidió cambiar el conjunto de frases de agradecimientos por expresiones de mínima comunicación (ver \textbf{\nameref{implementación:justificación_cambios}}). 
...
Por último, este Trabajo Terminal estará delimitado por un conjunto de 32 frases divididas en 3 grupos de: saludos (11 frases), situaciones de emergencias (11 frases) y expresiones de mínima comunicación (10 frases). Además, también se contemplaron otras 29 señas pertenecientes al alfabeto para el deletreo dactilológico, siendo así que el conjunto de datos estará delimitado a 61 elementos.
...
Este Trabajo Terminal busca desarrollar un prototipo de aplicación móvil que traduzca frases en español a LSM con animaciones fluidas, empleando técnicas de PLN y modelado 3D (ver \textbf{\nameref{anexo:blender_unity}}). Al mejorar la calidad de la comunicación entre personas oyentes y personas con discapacidad auditiva, se contribuye a la accesibilidad, a eliminar barreras de comunicación y fomentar la comunicación inclusiva.\\
...
Para el desarrollo del prototipo se utilizará MediaPipe \cite{ref7}, una biblioteca eficiente para procesamiento de gestos y movimientos corporales, ideal para capturar de manera precisa los gestos de la Lengua de Señas Mexicana (ver \textbf{\nameref{anexo:blender_unity}}). Esto permitirá obtener datos precisos de las señas, garantizando una traducción más confiable y fluida, mientras se mantiene un rendimiento óptimo incluso en dispositivos de gama media.\\

Finalmente, se busca crear representaciones visuales para poder facilitar la visualización de señas. Las personas con discapacidad auditiva podrán visualizar una animación asociada a una de las frases que están incluidas dentro del prototipo.\\

\textbf{Productos Esperados}
\begin{itemize}
    \item Dataset normalizado de LSM.
    \item Set de animaciones con animaciones fluidas e interactivas.
    \item Aplicación móvil en Android.
    \item Documentación del sistema.\\
\end{itemize}

\begin{center}
    \includegraphics[width=0.8\textwidth]{Images/Cap 1/diacajanegra3.png}
...
Los estudios analizados anteriormente indican que ya habido trabajos que han intentado auxiliar el proceso de comunicación entre una persona oyente y una persona sorda, aunque en su mayorían han sido a lenguas de señas de otros países como lo son la Lengua de Señas Colombiana (LSC), la Lengua de Señas Española (LSE), la Lengua de Señas Americana (ASL) y la Lengua de Señas Brasileña (LIBRAS). El enfoque del prototipo propuesto en el presente Trabajo Terminal es la Lengua de Señas Mexicana (LSM), empleando técnicas de IA, PLN y Modelado 3D (ver \textbf{\nameref{anexo:blender_unity}}) para crear animaciones optimizadas que permitan establecer comunicación entre personas oyentes y personas con discapacidad auditiva. \\
