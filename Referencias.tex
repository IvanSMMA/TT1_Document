...
\begin{thebibliography}{200}
    ...
    \bibitem{refebd1}
    I. Huerta, “Domina los Embeddings : La clave para el análisis semántico de contenidos, textos, documentaciones y keywords.”, Ikaue, s.f. [En línea]. Disponible en: \url{https://ikaue.com/blog-data/}. [Recuperado: 20-nov-2025].
    ...
    \bibitem{refc4-1}
    J. Vivanco, “El modelo C4 de documentación para la Arquitectura de Software”, Medium, 05-jun-2019. [En línea]. Disponible en: \url{https://medium.com/@javiervivanco/el-modelo-c4-de-documentaci%C3%B3n-para-la-arquitectura-de-software-424704528390}. [Recuperado: 06-nov-2025].

    \bibitem{refc4-2}
    Miro, “Modelo C4”, Miro, s.f. [En línea]. Disponible en: \url{https://miro.com/es/diagrama/que-es-modelo-c4/}. [Recuperado: 06-nov-2025]. 

    \bibitem{refc4-3}
    C4Model, “C4 model for software architecture”, C4Model, s.f. [En línea]. Disponible en: \url{https://c4model.info/#app}. [Recuperado: 06-nov-2025].
    ...
    \bibitem{refaws1}
    M. Gimenez, “Amazon Web Services (AWS): ¿qué es y qué ofrece?”, Hiberus Blog, 20-jul-2020. [En línea]. Disponible en: \url{https://www.hiberus.com/crecemos-contigo/amazon-web-services-aws-que-es-y-que-ofrece/}. [Recuperado: 03-nov-2025].
    ...
    \bibitem{refgoen0}
    GoEnhance AI, “Crear Videos con IA en minutos”, GoEnhance AI, 2025. [En línea]. Disponible en: \url{https://www.goenhance.ai/es}. [Recuperado: 06-nov-2025].

    \bibitem{refgoen1}
    AiShareNet, “GoEnhance: herramienta AI de conversión de vídeo a vídeo, mejora y ampliación de imágenes”, AiShareNet, 2024. [En línea]. Disponible en: \url{https://aisharenet.com/es/goenhanceshipinbu/}. [Recuperado: 06-nov-2025].

    \bibitem{refgoen2}
    AltaiDigital, “GoEnhance AI, Aplicación Inteligencia Artificial”, AltaiDigital, 2025. [En línea]. Disponible en: \url{https://www.altaidigital.co/aplicaciones/goenhance--ai?lang=pt}. [Recuperado: 06-nov-2025].

    \bibitem{refgoen3}
    El Directorio IA, “GoEnhance en español”, El Directorio IA, s.f. [En línea]. Disponible en: \url{https://www.eldirectorioia.com/herramientas-ia/goenhance}. [Recuperado: 06-nov-2025]. 
    ...
    \bibitem{brown2018c4}
    S. Brown, “The C4 Model for Software Architecture”, InfoQ, 2018. [En línea]. Disponible en: \url{https://www.infoq.com/articles/C4-architecture-model/}. [Recuperado: 02-dic-2025].
    
    \bibitem{vazquez2020c4}
    A. Vázquez-Ingelmo, A. García-Holgado y F. J. García-Peñalvo, “C4 model in a Software Engineering subject to ease the comprehension of UML and the software development process”, en \textit{2020 IEEE Global Engineering Education Conference (EDUCON)}, Porto, Portugal, 2020, pp. 919–924, doi: 10.1109/EDUCON45650.2020.9125335.
    
    \bibitem{fowler2002patterns}
    M. Fowler, “Patterns of Enterprise Application Architecture”, Boston, MA, EE. UU.: Addison-Wesley, 2002, ISBN 0-321-12742-0, 560 págs.
    
    \bibitem{dragoni2017micro}
    N. Dragoni, S. Giallorenzo, A. Lluch Lafuente, M. Mazzara, F. Montesi, R. Mustafin y L. Safina, “Microservices: Yesterday, Today, and Tomorrow”, en \textit{Present and Ulterior Software Engineering}, Cham, Suiza: Springer, 2017, pp. 195–216.
    
    \bibitem{aldebagy2018comparative}
    O. Al-Debagy y P. Martinek, “A Comparative Review of Microservices and Monolithic Architectures”, en \textit{2018 IEEE 18th International Symposium on Computational Intelligence and Informatics (CINTI)}, Budapest, Hungría, 2018, pp. 000153–000158, doi: 10.1109/CINTI.2018.8928192.
    
    \bibitem{newman2021microservices}
    S. Newman, “Building Microservices: Designing Fine-Grained Systems”, 2.ª ed., Sebastopol, CA, EE. UU.: O’Reilly Media, 2021, ISBN 978-1-492-03402-5.
    
    \bibitem{bass2012software}
    L. Bass, P. Clements y R. Kazman, “Software Architecture in Practice”, 3.ª ed., Boston, MA, EE. UU.: Addison-Wesley (SEI Series in Software Engineering), 2013, ISBN 978-0-321-81573-6.
    
    \bibitem{iso42010}
    ISO/IEC/IEEE, “ISO/IEC/IEEE 42010:2011 Systems and software engineering — Architecture description”, International Organization for Standardization, Ginebra, Suiza, 2011. [En línea]. Disponible en: \url{https://www.iso.org/standard/50508.html}. [Recuperado: 02-dic-2025].
    
    \bibitem{ref78}
    I. Sommerville, “Ingeniería del software”, 7.ª ed. Madrid, España: Pearson Educación, 2005, ISBN 84-7829-074-5, 712 págs.

    \bibitem{refapp1}
    Visual Studio Code, “The open source AI code editor”, Visual Studio Code, 2025. [En línea]. Disponible en: \url{https://code.visualstudio.com/}. [Recuperado: 24-nov-2025].

    \bibitem{refapp2}
    Actualizatec, “¿Qué es un APK? I Glosario de Mobile \& App Marketing,” Actualizatec, 08-jul-2023. [En línea]. Disponible en: \url{https://actualizatec.com/blog/que-es-un-apk/}. [Recuperado: 25-nov-2025].
    
    \bibitem{refapp3}
    Y. Fernández, “Archivos AAB de Android: qué son estos archivos y en qué se diferencian con los APK”, Xataka, 02-jul-2021. [En línea]. Disponible en: \url{https://www.xataka.com/basics/archivos-aab-android-que-estos-archivos-que-se-diferencian-apk}. [Recuperado: 25-nov-2025].
    
    \bibitem{refapp4}
    Expo, “Expo Application Services (EAS)”, Expo, 2023. [En línea]. Disponible en: \url{https://expo.dev/eas}. [Recuperado: 25-nov-2025].
    
    \bibitem{refapp5}
    AWS, “Microservicios”, Amazon Web Services, 14-nov-2025. [En línea]. Disponible en: \url{https://aws.amazon.com/es/microservices/}. [Recuperado: 25-nov-2025].
    
    \bibitem{refapp6}
    Render, “Cloud Application Platform | Render”, Render, 2025. [En línea]. Disponible en: \url{https://render.com/}. [Recuperado: 25-nov-2025].

    \bibitem{refapp7}
    Hugging Face, “Spaces”, Hugging Face, 2025. [En línea]. Disponible en: \url{https://huggingface.co/spaces}. [Recuperado: 29-nov-2025].
    ...
    \bibitem{refpirtes}
    L. García Cantillano, “¿Qué es la Pirámide de Pruebas?”, Medium, 08-oct-2022. [En línea]. Disponible en: \url{https://medium.com/nicasource/qu%C3%A9-es-la-pir%C3%A1mide-de-pruebas-6ac4356c963f}. [Recuperado: 25-nov-2025].

    \bibitem{refe2e}
    QAlified, “Una Guía Completa para las Pruebas End-To-End”, QAlified, 28-nov-2022. [En línea]. Disponible en: \url{https://qalified.com/es/blog/end-to-end-testing/}. [Recuperado: 25-nov-2025]

    \bibitem{refpru1}
    A. Munguira, “¿Qué es la escala de Likert y cómo utilizarla?”, QuestionPro, s.f. [En línea]. Disponible en: \url{https://www.questionpro.com/blog/es/que-es-la-escala-de-likert-y-como-utilizarla/}. [Recuperado: 24-nov-2025].
