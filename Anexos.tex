...
MediaPipe Holistic es un sistema que combina los modelos de pose, rostro y manos para realizar un análisis completo del cuerpo humano en tiempo real. Este enfoque holístico permite detectar un total de 543 puntos clave: 33 de pose, 468 del rostro y 21 por mano, procesando continuamente secuencias de imágenes para identificar gestos, posturas y movimientos corporales [hol1].\\

\begin{center}
    \includegraphics[width=0.8\textwidth]{Images/Anexos/MediaPipe_Holistic.png}
    \captionof{figure}[MediaPipe Holistic]{MediaPipe Holistic, obtenido de [hol2].}  % Pie de foto manual
\end{center}

El Modelo Holistic está diseñado para capturar simultáneamente expresiones faciales, gestos manuales y postura corporal, lo que lo convierte en una herramienta útil para aplicaciones de realidad aumentada, seguimiento de actividad física, interacción basada en gestos y otros entornos donde se requiere comprender el movimiento humano de manera integral [hol2].\\

Los principales componentes del modelo MediaPipe Holistic son los siguientes [hol2]:
\begin{itemize}
...
Entre las aplicaciones del modelo destacan principalmente las siguientes [hol2]:
\begin{itemize}
...
MediaPipe Holistic funciona como una canalización optimizada que integra los módulos de rostro, manos y pose para realizar seguimiento simultáneo. Su uso más común es detectar estas partes del cuerpo y extraer puntos clave para modelos de visión por computadora [hol3].\\
