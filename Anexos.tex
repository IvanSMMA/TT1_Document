...
\subsection{Blender}
Blender es una suite de animación y creación 3D libre y de código abierto, disponible para Linux, macOS y Windows. Permite desarrollar visualizaciones tridimensionales como imágenes, animaciones, efectos visuales (VFX), edición de video, entre otras [bl1]. Gracias a su versatilidad y a su constante evolución, se ha convertido en una herramienta ampliamente utilizada en ámbitos como la animación, el cine, los videojuegos, la arquitectura, el diseño gráfico y la impresión 3D [bl2][bl3].\\

Blender reúne en una sola plataforma todas las funciones necesarias para un flujo de trabajo completo en 3D. Entre sus características destacan [bl1][bl2][bl3]:
\begin{itemize}
...
Blender ofrece una variedad de herramientas profesionales que permiten desarrollar proyectos completos de animación, diseño y simulación [bl1][bl3][bl4]:
\begin{itemize}
...
Blender admite una amplia gama de formatos, lo que facilita la interoperabilidad con otras herramientas y flujos de trabajo en distintas industrias [bl2][bl4].
\begin{itemize}
...
\begin{center}
    ...
    \captionof{figure}[Logo de Blender]{Logo de Blender, obtenido de [bl5]}.
\end{center}
