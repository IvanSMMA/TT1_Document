...
\chapter[Anexo E. Cuestionario completo de evaluación de usabilidad]{Cuestionario completo de evaluación de usabilidad}
\label{anexo:cuestionario}

{\large \noindent \textbf{Evolución de la aplicación SingAI}}\\
...
\begin{enumerate}
    ...
    \item En caso afirmativo, ¿qué diferencias observa entre esta aplicación y las que había utilizado antes?
    \begin{itemize}
...
\begin{enumerate}
    \setcounter{enumi}{4}
    \item ¿Qué tan rápido y pertinente considera que fue el emparejamiento de la frase? (1 = muy lento/impreciso, 5 = muy rápido/pertinente)
    \begin{itemize}
        \item 1
        \item 2
        \item 3
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Fluido y claro
        \item Adecuado pero lento
        \item Lento o poco natural
        \item Confuso o difícil de seguir
    \end{itemize}
\end{enumerate}
...
Este cuestionario fue aplicado posterior al uso guiado del sistema. Las preguntas incluyen reactivos de opción múltiple, escalas Likert \cite{refpru1} y reactivos de respuesta abierta para obtener tanto información cuantitativa como cualitativa sobre la experiencia del usuario.
