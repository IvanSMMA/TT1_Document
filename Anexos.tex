...
\chapter[MediaPipe, Blender y Unity]{MediaPipe, Blender y Unity}
...
\begin{itemize}
	\item \textbf{Pose Sub-model}: estima 33 puntos clave del esqueleto humano, cubriendo articulaciones como hombros, codos, muñecas, cadera, rodillas y tobillos. Permite reconstruir poses corporales en tiempo real, útil para análisis de movimiento, deporte, danza y experiencias interactivas.
	\item \textbf{Face Sub-model}: detecta 468 puntos del rostro, incluyendo ojos, boca, nariz y contornos faciales. Su nivel de detalle permite reconocer expresiones, emociones y habilitar experiencias de realidad aumentada como filtros o maquillaje digital.
	\item \textbf{Hands Sub-model}: identifica 21 puntos por mano, capturando la forma y movimiento de los dedos. Esto permite aplicaciones como reconocimiento de lengua de señas, manipulación virtual o interfaces gestuales.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Fitness y salud}: seguimiento de posturas y movimientos para ofrecer retroalimentación en tiempo real.
...
\begin{itemize}
	\item Suite 3D integrada: Modelado, Esculpido, Texturizado, UV Mapping, Rigging, Animación, Simulación, Composición, VFX y Renderizado.
	...
	\item Comunidad activa que impulsa la mejora continua del software.
...
\begin{itemize}
	...
	\item \textbf{Rigging y animación}: sistema de huesos, controles avanzados, animación por fotogramas clave y plugins.
	...
	\item \textbf{Composición y VFX}: nodos, tracking de cámara, integración de efectos visuales.
...
\chapter[LGPID]{Ley General para la Inclusión de las Personas con Discapacidad}
...
\chapter[Enfoque por actividades (académico)]{Enfoque por actividades (académico)}
...
\chapter[Enfoque por actividades (comercial)]{Enfoque por actividades (comercial)}
...
\chapter[Cuestionario de evaluación de usabilidad]{Cuestionario completo de evaluación de usabilidad}
