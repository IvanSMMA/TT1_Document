...
\begin{center}
	\includegraphics[width=0.7\textwidth]{Images/Cap 3/d_arq.jpg}
...
\begin{center}
    \includegraphics[width=1\textwidth]{Images/Cap 3/Procesos.jpeg}
...
\begin{center}
<<<<<<< HEAD
    \includegraphics[width=1\textwidth]{Images/Cap 3/clases.jpeg }
    \captionof{figure}{Diagrama de clases del sistema} 
=======
    \includegraphics[width=0.6\textwidth]{Images/Cap 3/clasesJV.png}
    \captionof{figure}{Diagrama de clases del sistema.} 
>>>>>>> 5830684019f442ce920a9de8efa33fa7a0cd2f84
\end{center}

\subsubsection{Diagrama de secuencia}
\begin{center}
    \includegraphics[width=0.5\textwidth]{Images/Cap 3/Secuencia.png}
