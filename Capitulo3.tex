...
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/contexto_hugging.png}
	\captionof{figure}[Diagrama de contexto (C4 nivel 1)]{Diagrama de contexto (C4 nivel 1), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/bdz2har4}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}

\subsubsection{Diagrama de contenedores (C4 nivel 2)}
\begin{center}
	\includegraphics[width=0.65\textwidth]{Images/Cap 3/contenedores_hugging.png}
	\captionof{figure}[Diagrama de contenedores (C4 nivel 2)]{Diagrama de contenedores (C4 nivel 2), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/4896r8yc}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}

\newpage
\subsubsection{Diagrama de componentes (C4 nivel 3)}
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/componentes_hugging.png}
	\captionof{figure}[Diagrama de componentes (C4 nivel 3]{Diagrama de componentes (C4 nivel 3), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/3kvvykjr}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}

\subsubsection{Diagrama de arquitectura en capas (3 Tier)}
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/capas_hugging.png}
	\captionof{figure}[Diagrama de arquitectura en capas (3 Tier)]{Diagrama de arquitectura en capas (3 Tier), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/mezh7t24}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}
