...
En concreto, se empleó la plataforma \textit{GoEnhance AI} (\textit{GoEnhance AI - All-in-One AI Video Generator}), la cual permite crear videos a partir de texto, imágenes o clips existentes utilizando modelos avanzados de generación de video (por ejemplo, Runway, Kling o Veo~3). Este enfoque reduce la complejidad técnica asociada al rigging, al control de esqueletos 3D y a la integración de motores gráficos en tiempo real, permitiendo que el equipo concentre sus esfuerzos en el diseño del flujo de traducción, el procesamiento de texto y la integración de los videos de señas en la aplicación móvil.
...
Actualmente existen diversas tecnologías y herramientas que facilitan la creación de sistemas de apoyo a la traducción de texto a señas, tales como conjuntos de datos de señas en video, plataformas de generación de video con IA, frameworks para el desarrollo de aplicaciones móviles y librerías para el procesamiento de lenguaje natural. En el presente proyecto se privilegiaron soluciones que reducen la carga de infraestructura y la complejidad de integración, aprovechando servicios en la nube y herramientas de desarrollo multiplataforma.
...
\begin{itemize}
	...
	\item La plataforma \textit{GoEnhance AI}, empleada para generar videos de señas a partir de descripciones textuales, lo que permite obtener recursos audiovisuales consistentes sin requerir un pipeline local de modelado 3D ni motores de animación en tiempo real.
	\item Frameworks de desarrollo móvil como React (19.0.0) y Expo SDK (54.0.0), que facilitan la construcción de una aplicación multiplataforma y la integración de videos de señas en la interfaz de usuario.
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{|p{7cm}|r|r|r|}
			...
			Licencia de software y/o servicios para animación y edición de video & \$1,500.00 & \$6,000.00 & \$18,000.00 \\ \hline
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{|p{7cm}|c|r|r|}
			...
			Capacitación online (cursos: PLN, LSM, Nube, etc.) & 3 cursos & \$800.00 & \$2,400.00 \\ \hline
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{|p{5.5cm}|c|r|r|r|r|}
			...
			Asesoría en animaciones (freelance) & 1 parcial & \$300.00 (por sesión) & \$1,200.00 (cuatro sesiones) & -- & -- \\ \hline
...
La asignación de tres integrantes al proyecto se fundamenta mediante una estimación del esfuerzo utilizando el modelo \textbf{COCOMO II (Constructive Cost Model II)}, específicamente en su modalidad \textit{Early Design Model}, apropiada para proyectos en etapas iniciales \cite{refcocomo}.\\
...
El equipo de trabajo dispone del equipo de cómputo necesario para el desarrollo, prueba y validación de la aplicación móvil. Además, se cuenta con acceso a las plataformas de desarrollo y a las herramientas de software requeridas, tales como ambientes de programación, bibliotecas especializadas de procesamiento de lenguaje natural (PLN), etc. Esta disponibilidad de recursos tecnológicos garantiza las condiciones adecuadas para la implementación efectiva del prototipo.
...
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/contenedores_vf.png}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|X|X|}
		\hline
		\textbf{Emergencia (3 a 4 palabras)} & \textbf{Saludo (1 a 3 palabras)} & \textbf{Expresiones de Mínima Comunicación (2 a 4 palabras)} \\ \hline
