...
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/contexto_vf.png}
	\captionof{figure}[Diagrama de contexto (C4 nivel 1)]{Diagrama de contexto (C4 nivel 1), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/5cvnfn3s}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}

\subsubsection{Diagrama de contenedores (C4 nivel 2)}
\begin{center}
	\includegraphics[width=0.7\textwidth]{Images/Cap 3/contenedores_vf.png}
	\captionof{figure}[Diagrama de contenedores (C4 nivel 2)]{Diagrama de contenedores (C4 nivel 2), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/4wjeeuzb}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/capas_vf.png}
	\captionof{figure}[Diagrama de arquitectura en capas (3 Tier)]{Diagrama de arquitectura en capas (3 Tier), elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/3wekk86t}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}
...
\begin{center}
	\includegraphics[width=0.4\textwidth]{Images/Cap 3/clases_vf.png}
	\captionof{figure}[Diagrama de clases]{Diagrama de clases, elaboración propia. 
		Véase la versión SVG para mayor detalle en \href{https://tinyurl.com/2nmxvc9f}{\textbf{\underline{este enlace}}}.}  % Pie de foto manual
\end{center}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|X|X|}
		\hline
		\textbf{Emergencia (3 a 4 palabras)} & \textbf{Saludo (1 a 3 palabras)} & \textbf{Expresiones de Mínima Comunicación (1 a 3palabras)} \\ \hline
		...
		¿Necesitas ayuda? & Mucho gusto. & Perdón. \\ \hline
		¿Dónde está la salida? & ¿Cómo te llamas? & Entiendo. \\ \hline
		Incendio & Me llamo [nombre]. & No Entiendo. \\ \hline
		Estoy sangrando. & Nos vemos. & No lo sé. \\ \hline
		Alto. & Me voy. & Muchas gracias. \\ \hline
		Auxilio. & Adios. & Te lo agradezco. \\ \hline
		Socorro. & Hasta luego. & Espera. \\ \hline
		 &  & Disculpa. \\ \hline
		 &  & Lo siento. \\ \hline
		 &  & De acuerdo. \\ \hline
		 &  & Vale. \\ \hline
