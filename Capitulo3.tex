...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{|p{7cm}|c|r|r|}
			...
			Cursos y certificaciones profesionales (PLN, UX, IA, LSM) & 4 & \$3,000.00 & \$12,000.00 \\ \hline
...
\begin{table}[H]
	...
	\begin{adjustbox}{max width=\linewidth}
		...
		\begin{tabular}{|c|p{8.1cm}|p{4.6cm}|}
			...
			RNF03 & Las animaciones entre señas deben ser fluidas y naturales, evitando movimientos bruscos o poco realistas. & 
			\begin{tabular}[t]{@{}p{4.6cm}@{}}
