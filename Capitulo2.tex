...
En resumen, la similitud del coseno es la métrica estándar para comparar embeddings, ya que ofrece una forma robusta de evaluar el parecido semántico entre textos mediante la orientación de sus vectores en el espacio \cite{refcos3}.\\
...
\begin{enumerate}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth]{Images/Cap 2/Transformers/Transformers1.jpg}
...
\begin{center}
    \includegraphics[width=0.95\textwidth]{Images/Cap 2/Transformers/Transformers2.jpg}
