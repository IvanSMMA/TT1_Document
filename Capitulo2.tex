...
\begin{center}
    ...
    \captionof{figure}[Logo Expo]{React Expo, obtenido de [p5].} 
\end{center}
...
\begin{center}
    ...
    \captionof{figure}[Nube]{Funcionamiento de los Servicios en la Nube, obtenido de [n5].} 
\end{center}
...
\begin{center}
    ...
    \captionof{figure}[Logo AWS]{Amazon Web Services (AWS), obtenido de [aws4].} 
\end{center}
...
\begin{center}
    ...
    \captionof{figure}[Microservicios]{Arquitectura de Microservicios, obtenido de [m5].} 
\end{center}
